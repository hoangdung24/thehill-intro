  ...
  return (
    <Wrapper>
      <Stack spacing={4} direction="row">
        ...
        <SubcriberBox className="Subcriber Form" component="form" onSubmit={handleSubmit(onSubmit)}>
          <InputEmail variant="outlined" margin="normal" fullWidth id="1" {...register("email")} />
